...
export function CategoriesAnalyticsTab({ modelDefinition, registros }: CategoriesAnalyticsTabProps) {
    const [campoSeleccionado, setCampoSeleccionado] = useState<string>(
        modelDefinition.campos[0]?.nombre || ''
    );
    ...
    return (
        <div className="p-4 border rounded-lg">
            <h2 className="text-lg font-bold mb-4">Analítica dinámica</h2>
